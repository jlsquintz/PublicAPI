...
/**
 * <p>Demonstrates creating a new high bid for a product as a buyer.</p>
 */
public class PlaceNewHighestBidExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			ProductInfoData data = productInfo.getData()
											.stream()
											.findAny()
											.get();
			...
			int highestBid = marketData.getMarket().getHighestBid();
			highestBid++;

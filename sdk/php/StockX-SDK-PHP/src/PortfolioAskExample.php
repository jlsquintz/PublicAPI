...
try {
    ...
    $portfolioItemReq = new Swagger\Client\Model\PortfolioRequestPortfolioItem();
        ...
        $portfolioItemReq->setMatchedWithDate("2012-12-12T05:00:00+0000");
        $portfolioItemReq->setCondition("2000");
        $portfolioItemReq->setAction(1000);
        
    $customer = new Swagger\Client\Model\CustomerObject();
    ...
    echo 'Exception when calling StockXApi->createPortfolioAsk: ', $e->getMessage(), PHP_EOL;
}
...
/**
 * PortfolioitemsIdGetResponsePortfolioItemProductMarket Class Doc Comment
 *
 * @category Class
 * @package  StockX\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PortfolioitemsIdGetResponsePortfolioItemProductMarket implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'portfolioitems_id_get_response_PortfolioItem_product_market';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['lowest_ask'] === null) {
            $invalidProperties[] = "'lowest_ask' can't be null";
        }
        if ($this->container['lowest_ask_size'] === null) {
            $invalidProperties[] = "'lowest_ask_size' can't be null";
        }
        if ($this->container['number_of_asks'] === null) {
            $invalidProperties[] = "'number_of_asks' can't be null";
        }
        if ($this->container['sales_this_period'] === null) {
            $invalidProperties[] = "'sales_this_period' can't be null";
        }
        if ($this->container['sales_last_period'] === null) {
            $invalidProperties[] = "'sales_last_period' can't be null";
        }
        if ($this->container['highest_bid'] === null) {
            $invalidProperties[] = "'highest_bid' can't be null";
        }
        if ($this->container['highest_bid_size'] === null) {
            $invalidProperties[] = "'highest_bid_size' can't be null";
        }
        if ($this->container['number_of_bids'] === null) {
            $invalidProperties[] = "'number_of_bids' can't be null";
        }
        if ($this->container['annual_high'] === null) {
            $invalidProperties[] = "'annual_high' can't be null";
        }
        if ($this->container['annual_low'] === null) {
            $invalidProperties[] = "'annual_low' can't be null";
        }
        if ($this->container['deadstock_range_low'] === null) {
            $invalidProperties[] = "'deadstock_range_low' can't be null";
        }
        if ($this->container['deadstock_range_high'] === null) {
            $invalidProperties[] = "'deadstock_range_high' can't be null";
        }
        if ($this->container['volatility'] === null) {
            $invalidProperties[] = "'volatility' can't be null";
        }
        if ($this->container['deadstock_sold'] === null) {
            $invalidProperties[] = "'deadstock_sold' can't be null";
        }
        if ($this->container['price_premium'] === null) {
            $invalidProperties[] = "'price_premium' can't be null";
        }
        if ($this->container['average_deadstock_price'] === null) {
            $invalidProperties[] = "'average_deadstock_price' can't be null";
        }
        if ($this->container['last_sale'] === null) {
            $invalidProperties[] = "'last_sale' can't be null";
        }
        if ($this->container['last_sale_size'] === null) {
            $invalidProperties[] = "'last_sale_size' can't be null";
        }
        if ($this->container['sales_last72_hours'] === null) {
            $invalidProperties[] = "'sales_last72_hours' can't be null";
        }
        if ($this->container['change_value'] === null) {
            $invalidProperties[] = "'change_value' can't be null";
        }
        if ($this->container['change_percentage'] === null) {
            $invalidProperties[] = "'change_percentage' can't be null";
        }
        if ($this->container['abs_change_percentage'] === null) {
            $invalidProperties[] = "'abs_change_percentage' can't be null";
        }
        if ($this->container['total_dollars'] === null) {
            $invalidProperties[] = "'total_dollars' can't be null";
        }
        if ($this->container['updated_at'] === null) {
            $invalidProperties[] = "'updated_at' can't be null";
        }
        if ($this->container['last_lowest_ask_time'] === null) {
            $invalidProperties[] = "'last_lowest_ask_time' can't be null";
        }
        if ($this->container['last_highest_bid_time'] === null) {
            $invalidProperties[] = "'last_highest_bid_time' can't be null";
        }
        if ($this->container['last_sale_date'] === null) {
            $invalidProperties[] = "'last_sale_date' can't be null";
        }
        if ($this->container['created_at'] === null) {
            $invalidProperties[] = "'created_at' can't be null";
        }
        if ($this->container['deadstock_sold_rank'] === null) {
            $invalidProperties[] = "'deadstock_sold_rank' can't be null";
        }
        if ($this->container['price_premium_rank'] === null) {
            $invalidProperties[] = "'price_premium_rank' can't be null";
        }
        if ($this->container['average_deadstock_price_rank'] === null) {
            $invalidProperties[] = "'average_deadstock_price_rank' can't be null";
        }

<?php
/**
 * PortfolioitemsIdGetResponsePortfolioItemProduct
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PortfolioitemsIdGetResponsePortfolioItemProduct Class Doc Comment
 *
 * @category Class
 * @package  StockX\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PortfolioitemsIdGetResponsePortfolioItemProduct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'portfolioitems_id_get_response_PortfolioItem_product';
    ...
    protected static $swaggerTypes = [
        ...
        'minimum_bid' => 'int',
        'media' => '\StockX\Client\Model\PortfolioIdDelResponsePortfolioItemProductMedia',
        'name' => 'string',
        ...
        'shipping' => '\StockX\Client\Model\PortfolioIdDelResponsePortfolioItemProductShipping',
        'children' => 'object',
        'parent_id' => 'string',
        'parent_uuid' => 'string',
        'size_sort_order' => 'int',
        'shoe_size' => 'string',
        'market' => '\StockX\Client\Model\PortfolioitemsIdGetResponsePortfolioItemProductMarket',
        'upc' => 'string'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['charity_condition'] === null) {
            $invalidProperties[] = "'charity_condition' can't be null";
        }
        if ($this->container['colorway'] === null) {
            $invalidProperties[] = "'colorway' can't be null";
        }
        if ($this->container['condition'] === null) {
            $invalidProperties[] = "'condition' can't be null";
        }
        if ($this->container['country_of_manufacture'] === null) {
            $invalidProperties[] = "'country_of_manufacture' can't be null";
        }
        if ($this->container['gender'] === null) {
            $invalidProperties[] = "'gender' can't be null";
        }
        if ($this->container['content_group'] === null) {
            $invalidProperties[] = "'content_group' can't be null";
        }
        ...
        if ($this->container['primary_category'] === null) {
            $invalidProperties[] = "'primary_category' can't be null";
        }
        if ($this->container['secondary_category'] === null) {
            $invalidProperties[] = "'secondary_category' can't be null";
        }
        ...
        if ($this->container['shoe'] === null) {
            $invalidProperties[] = "'shoe' can't be null";
        }
        ...
        if ($this->container['size_title'] === null) {
            $invalidProperties[] = "'size_title' can't be null";
        }
        if ($this->container['size_descriptor'] === null) {
            $invalidProperties[] = "'size_descriptor' can't be null";
        }
        if ($this->container['size_all_descriptor'] === null) {
            $invalidProperties[] = "'size_all_descriptor' can't be null";
        }
        ...
        if ($this->container['a_lim'] === null) {
            $invalidProperties[] = "'a_lim' can't be null";
        }
        ...
        if ($this->container['parent_uuid'] === null) {
            $invalidProperties[] = "'parent_uuid' can't be null";
        }
        if ($this->container['size_sort_order'] === null) {
            $invalidProperties[] = "'size_sort_order' can't be null";
        }
        if ($this->container['shoe_size'] === null) {
            $invalidProperties[] = "'shoe_size' can't be null";
        }
     ...
     * Gets media
     *
     * @return \StockX\Client\Model\PortfolioIdDelResponsePortfolioItemProductMedia
     */
     ...
     * Sets media
     *
     * @param \StockX\Client\Model\PortfolioIdDelResponsePortfolioItemProductMedia $media media
     *
     * @return $this
     */
     ...
     * Gets shipping
     *
     * @return \StockX\Client\Model\PortfolioIdDelResponsePortfolioItemProductShipping
     */
     ...
     * Sets shipping
     *
     * @param \StockX\Client\Model\PortfolioIdDelResponsePortfolioItemProductShipping $shipping shipping
     *
     * @return $this
     */
     ...
     * Gets market
     *
     * @return \StockX\Client\Model\PortfolioitemsIdGetResponsePortfolioItemProductMarket
     */
     ...
     * Sets market
     *
     * @param \StockX\Client\Model\PortfolioitemsIdGetResponsePortfolioItemProductMarket $market market
     *
     * @return $this
     */

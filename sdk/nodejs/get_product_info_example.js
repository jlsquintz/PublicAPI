...
stockx.loginWithHttpInfo(login)
	.then(res => {
		...
		return stockx.getProductById('air-jordan-1-retro-high-off-white-chicago', null);
	}).then(result => {
		console.log('Product fetch successful: ' + JSON.stringify(result));
	}).catch(err => {
		console.log('Error performing product fetch: ' + err);
	});